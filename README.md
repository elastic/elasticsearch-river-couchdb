...
```sh
bin/plugin -install elasticsearch/elasticsearch-river-couchdb/2.4.0
```
...
|    es-1.x              | Build from source  | [2.5.0-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-river-couchdb/tree/es-1.x/#version-250-snapshot-for-elasticsearch-1x)|
|    es-1.4              |     2.4.0         | [2.4.0](https://github.com/elasticsearch/elasticsearch-river-couchdb/tree/v2.4.0/#version-240-for-elasticsearch-14)                  |
